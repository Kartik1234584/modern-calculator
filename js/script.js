...
(() => {
  ...
  const functions = {
    'sqrt': v => Math.sqrt(v),
    'sin': v => Math.sin(v * (degToggle.checked?Math.PI/180:1)),
    'cos': v => Math.cos(v * (degToggle.checked?Math.PI/180:1)),
    'tan': v => Math.tan(v * (degToggle.checked?Math.PI/180:1)),
    'log': v => Math.log10(v),
    'ln': v => Math.log(v),
    'asin': v => Math.asin(v) * (degToggle.checked?180/Math.PI:1),
    'acos': v => Math.acos(v) * (degToggle.checked?180/Math.PI:1),
    'atan': v => Math.atan(v) * (degToggle.checked?180/Math.PI:1),
    'sinh': v => Math.sinh(v),
    'cosh': v => Math.cosh(v),
    'tanh': v => Math.tanh(v),
    'exp': v => Math.exp(v)
